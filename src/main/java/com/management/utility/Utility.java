...
import com.management.exceptions.RandomGeneratorUnavailableException;
...
public class Utility {
    ...
    public static final String APP_NAME = "Hsopital-Management";
...
//
//    public static String formatErrorFound(boolean errorFound) {
//        return errorFound == false ? UploadFilter.Successful.name() : UploadFilter.Failed.name();
//    }

    public static String batchId(String agentCode) {
        DateFormat df = new SimpleDateFormat("yyMMddHHmmssss");
        String datePart = df.format(new java.util.Date());
        return agentCode + datePart;// + next(2);
    }
